package com.example.DukeStrategicTechnologies.pki.config;


import com.example.DukeStrategicTechnologies.pki.security.TokenUtils;
import com.example.DukeStrategicTechnologies.pki.security.auth.RestAuthenticationEntryPoint;
import com.example.DukeStrategicTechnologies.pki.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll().antMatchers("/certificate/getRootCertificates").permitAll()
                .antMatchers("/certificate/getEndEntityCertificates").permitAll().antMatchers("/certificate/getCaCertificates").permitAll()
